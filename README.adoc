...
[WARNING]
--
There is now an https://portableapps.com/apps/graphics_pictures/sharex-portable[
official release of ShareX on PortableApps.com].

Please use the official release as this repository will no longer be maintained
and no more releases will be published here.
--
...
>>
<<runtime-dependencies,
  image:https://img.shields.io/badge/depends%20on-.%20Net-blue[Depends on]
>>
...
https://getsharex.com[ShareX] is a free and open source program that lets you
capture or record any area of your screen and share it with a single press of a
key. It also allows uploading images, text or other types of files to many
supported destinations you can choose from.

It is published under the GNU General Public License. The project's source code
is hosted at the GitHub code-sharing and code development platform.
